// components/SkillPersonalityTestButton.jsx
'use client'

import { Button } from '@/components/ui/button'
import { ClipboardList } from 'lucide-react'

export default function SkillPersonalityTestButton({ assignedTest }) {
	const handleTestStart = () => {
		...
		const testWindow = window.open(
			`/panel/skill-personality-test/take/${assignedTest.id}`,
			'_blank',
			features
		)
